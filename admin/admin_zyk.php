...
<tr>
<td width="10%" align="left" height="30" class="td_border"><br>
&nbsp;&nbsp;<input type="submit" value="添加资源库" class="btn" > <br><br>&nbsp;&nbsp;<a href="admin_player.php?action=boardsource"><font style="font-size:14px;color:#4397a4">=>设置播放来源</font></a><br><br>
</td>
</tr>
