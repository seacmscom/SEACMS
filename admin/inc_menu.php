...
$menu=array (
	...
	'tool'=>array (
		...
		10=>"",
		11=>"<a target='I2' href='admin_datarelate.php?action=fileperms'>目录权限检查</a>",
		12=>"<a target='I2' href='admin_safe.php'>木马扫描工具</a>",
		13=>"<a target='I2' href='admin_safe_file.php'>文件校验工具</a>",
		14=>"<a target='I2' href='admin_safe_xss.php'>挂马清除工具</a>",
		15=>"",
		16=>"<a target='I2' href='admin_datarelate.php?action=sql'>SQL高级助手</a>",
		17=>"<a target='I2' href='ebak/ChangeDb.php?act=b'>数据库备份</a>",
		18=>"<a target='I2' href='ebak/ReData.php'>数据库还原</a>",
		19=>"<a target='I2' href='ebak/ChangePath.php'>备份文件管理</a>",
		20=>"<a target='I2' href='ebak/ChangeDb.php?act=y'>数据库修复优化</a>",
	),
	'gathersoft'=>array (
		'link'=>"api.php",
		0=>"采集",
