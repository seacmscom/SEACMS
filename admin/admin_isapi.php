...
<?php
$vo1=explode('#',file_get_contents("../data/admin/isapi.txt")); 
$v1=$vo1[0];
$o1=$vo1[1];
if($o1=="" OR empty($o1)){$o1=1;}
?>

<tr>
<td width="80%" align="left" height="30" class="td_border">
资源接口开关：&nbsp;&nbsp;<input type="radio" name="v" value="0" <?php  if($v1==0) echo 'checked';?>>关闭
&nbsp;&nbsp;
...
<tr>
<td width="80%" align="left" height="30" class="td_border">
资源排序方式：&nbsp;&nbsp;<input type="radio" name="o" value="1" <?php  if($o1==1) echo 'checked';?>>时间倒序
&nbsp;&nbsp;<input type="radio" name="o" value="2" <?php  if($o1==2) echo 'checked';?>>时间正序
&nbsp;&nbsp;<input type="radio" name="o" value="3" <?php  if($o1==3) echo 'checked';?>>ID倒叙
&nbsp;&nbsp;<input type="radio" name="o" value="4" <?php  if($o1==4) echo 'checked';?>>ID正序
