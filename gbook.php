...
.sea_page a{float:left;font-family:Tahoma;height:22px;line-height:22px;padding:0 8px;margin-left:3px;background-color:#ddd;border-radius: 2px;font-size: 12px;color: #405884;list-style:none;}
...
.sea_page .sea_num{float:left;font-family:Tahoma;height:22px;line-height:22px;padding:0 8px;margin-left:3px;background-color:#6394c8;border-radius: 2px;font-size: 12px;color: #fff;list-style:none;}

.sea_title{font-size: 16px;margin-bottom:8px; font-weight:bold;}
.sea_main_6{list-style:none;}
.sea_main_8{width:100%;height:60px;border:0;background-color:#f5f5f52b;font-size:14px; line-height:22px;font-family:Microsoft YaHei;border: 1px solid #0d0d0d1c;border-radius:2px; margin-bottom:6px;}
.sea_main_8 input,textarea{
                outline: none;
                border: #0d0d0d1c 1px solid;
            }
 

.sea_postsub{float:right;margin-right:2px;}
.sea_postsub img{align:middle;height:28px; line-height:30px;border:0;border-radius: 2px;}
.sea_main_9{text-transform: uppercase;width: 60px;height:28px;text-align: center;border-radius: 2px;background-color: #f5f5f52b;border: 1px solid #0d0d0d1c;align:middle;}
.sea_main_11{align:middle;cursor:pointer;color: #fff;width: 80px;cursor:pointer;background-color: #5682b2;height: 28px;border:0; border-radius:2px;}
...
function viewLeaveWord2(){
	...
	"</div>".
	  ...
	  "<div class=\"sea_postsub\">".
		 	"<img id=\"vdimgck\" src=\"include/vdimgck.php\" alt=\"看不清？点击更换\"  align=\"absmiddle\"  style=\"cursor:pointer;display:none;\" onClick=\"this.src=this.src+'?get=' + new Date()\"/>&nbsp;<input name=\"validate\" type=\"text\" placeholder=\"验证码\" class=\"sea_main_9\" id=\"vdcode\" style=\"text-transform:uppercase;\" onClick=\"document.getElementById('vdimgck').style.display='inline';\" tabindex=\"3\"/>&nbsp;<input type=\"submit\"  value=\"提交留言\" class=\"sea_main_11\"/> </div>".
	"</div></div></form>".
	"</div></div></div>".
	"<div class=\"sea_main_12\">".leaveWordList($_GET['page'])."</div><script type=\"text/javascript\" src=\"js/base.js\"></script>";
	return $mystr;
